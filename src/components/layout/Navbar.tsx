      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between h-16">
          ...
          <div className="flex items-center gap-6">
                <div className="">
                  <Link href="/" className="text-white hover:text-light_green flex items-center align-middle gap-2 transition duration-150">
                ...
                <div className="">
                  <Link href="/owned-assets" className="text-white hover:text-light_green flex items-center gap-2 transition duration-150">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="size-5">
